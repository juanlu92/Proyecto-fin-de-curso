...
$_SESSION['nombrehabitacion']=$nombrehabitacion;
?>
<html leng = "es">
<head>
  <meta charset = "UTF-8">
...
<div class="row">
  <div class="col-md-6 col-md-offset-3"><br>
      <div class="well row pt-2x pb-3x bk-light">
        ...
        <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatosaltahabitaciones.php" width="150" height="500">
          <br><br><br>
          <?php
          ...
          echo "<form method='post'  action='enviardatosaltahabitaciones.php'>";
          echo "<pre class='texto'>Selecciona la casa a la que añadir la habitacion: </pre>";
          echo "<select name='anadircomponente'>";
          ...
          //echo "$row['idCasa']";
          echo "<input type='submit' value='Añadir' name='submit'>";
          echo "<br><br>";
