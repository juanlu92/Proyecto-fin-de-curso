  ...
  <div class="ts-main-content">
      ...
      <div class="container">
        ...
        <?php
            ...
            echo '<br>';
            echo '<br>';
            $nombrehabitacion = $_SESSION['nombrehabitacion'];
            $anadircomponente = $_POST['anadircomponente'];
            echo '<br>';
            echo '<br>';
            echo '<br>';
            $ordenar=mysql_query('ALTER TABLE Habitaciones AUTO_INCREMENT=1');
            $altahabitacion = new habitaciones;
            $altahabitacion->altahabitacion($nombrehabitacion, $anadircomponente);
        ?>
