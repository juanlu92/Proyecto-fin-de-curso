...
<div class="row">
  <div class="col-md-6 col-md-offset-3"><br>
      <div class="well row pt-2x pb-3x bk-light">
        ...
        <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatosborrarcasa.php" width="150" height="500">
          <br><br><br>
          <?php
          ...
          echo "<form method='post'  action='enviardatosborrarcasa.php'>";
          echo "<pre class='texto'>Selecciona la casa que quieras borrar: </pre>";
          echo "<select name='nombrecasa'>";
