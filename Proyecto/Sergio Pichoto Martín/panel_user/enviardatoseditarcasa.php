  ...
  <div class="ts-main-content">
      ...
      <div class="container">
        ...
        <?php
            ...
            echo '<br>';
            echo '<br>';
            $viejonombrecasa = $_SESSION['viejonombrecasa'];
            $nombredelacasa=$_POST['nombrecasa'];
            $_SESSION['nombrecasa']=$nombredelacasa;
            echo '<br>';
            echo '<br>';
            echo '<br>';
            $editarcasa=new casas;
            $editarcasa->editarcasa($viejonombrecasa, $nombredelacasa);
        ?>
