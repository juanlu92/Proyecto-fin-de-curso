...
<div class="row">
  <div class="col-md-6 col-md-offset-3"><br>
      <div class="well row pt-2x pb-3x bk-light">
        ...
        <form id="f1" name="f1" method="post" onsubmit="return validar();" action="editar_casa_buscador_resultado.php" width="150" height="500">
          <div class="mt">
            <label for="" class="text-uppercase text-sm">Busca la casa a editar</label>
