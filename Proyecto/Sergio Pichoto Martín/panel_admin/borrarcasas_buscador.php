...
<ul class="ts-profile-nav">
  <li><a href="pagina_panel_administrador.php">Panel de casas principal</a></li>
...
<div class="row">
  <div class="col-md-6 col-md-offset-3"><br>
      <div class="well row pt-2x pb-3x bk-light">
        ...
        <form id="f1" name="f1" method="post" onsubmit="return validar();" action="borrarcasas.php" width="150" height="500">
          <div class="mt">
            <label for="" class="text-uppercase text-sm">Busca la casa a borrar</label>
            <input type="text" placeholder="Escriba el nombre de tu casa" id='busqueda' name="busqueda" class="form-control mb" required />
            <button class="btn btn-primary btn-block" type="submit" name='Enviar' class="boton" value='Enviar'>Buscar</button>
            <br><br>
