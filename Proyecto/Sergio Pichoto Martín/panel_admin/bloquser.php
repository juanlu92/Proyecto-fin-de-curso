    ...
    <div class="col-md-6 col-md-offset-3"><br><br>
        <div class="well row pt-2x pb-3x bk-light">
          <div class="col-md-8 col-md-offset-2">
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatosbloquser.php" width="150" height="500">
              <div class "mt">

                <label for="" class="text-uppercase text-sm">¿Quieres Bloquear o Desbloquear?</label>

                <select class="form-control mb" id='estadouser' name="estadouser" required />
                  <option value="0">Bloquear</option>
                  <option value="1">Desbloquear</option>
                </select>

                <label for="" class="text-uppercase text-sm">  Escribe el Correo Electronico del usuario a bloquear:</label>
                <input type="text" placeholder="Escriba el Correo Electronico" id='bloquearusuario' name="bloquearusuario" class="form-control mb" pattern="{1,15}"required />

                <button class="btn btn-primary btn-block" type="submit" name='Enviar' class="boton" value='Enviar'>Borrar</button><br><br>
