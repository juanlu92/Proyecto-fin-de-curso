      ...
      <ul class="ts-profile-nav">
            ...
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatoseditarcomponentes.php" width="150" height="500">
                <div class "mt">
                  ...
                  <label for="" class="text-uppercase text-sm">ID del Componente a editar:</label>
                  <input type="text" placeholder="Escriba el ID del componente" id='idcomponente' name="idcomponente" class="form-control mb" pattern="{1,15}" required=""/>
