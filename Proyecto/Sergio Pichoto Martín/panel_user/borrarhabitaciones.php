    ...
    <div class="col-md-6 col-md-offset-3"><br><br>
        <div class="well row pt-2x pb-3x bk-light">
          <div class="col-md-8 col-md-offset-2">
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatosborrarhabitaciones.php" width="150" height="500">
              <div class "mt">

                <label for="" class="text-uppercase text-sm">Escribe el nombre de la habitacion a borrar:</label>
                <input type="text" placeholder="Escriba el nombre" id='nombreHabitacion' name="nombreHabitacion" class="form-control mb" pattern="{1,15}" required />

                <button class="btn btn-primary btn-block" type="submit" name='Enviar' class="boton" value='Enviar'>Borrar</button>
                <br><br>
