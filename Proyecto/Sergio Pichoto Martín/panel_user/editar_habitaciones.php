  ...
  <body background=".././Recursos/img/fondo.jpg">
      ...
      <ul class="ts-profile-nav">
            ...
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatoseditarhabitaciones.php" width="150" height="500">
              ...
              <label for="" class="text-uppercase text-sm">ID de la habitación a editar:</label>
              <input type="text" placeholder="Escriba el ID" id='elidhabitacion' name="elidhabitacion" class="form-control mb" pattern="{1,15}" required=""/>

              <label for="" class="text-uppercase text-sm">Nuevo nombre de la habitacion:</label>
              <input type="text" placeholder="Escriba el nuevo nombre" id='nuevonombre' name="nuevonombre" class="form-control mb" pattern="[a-zA-Zñ ]+[a-zA-Zñ]{1,15}" required=""/>

              <label for="" class="text-uppercase text-sm">Nuevo ID de casa asociada:</label>
              <input type="text" placeholder="Escriba el ID" id='nuevoidcasa' name="nuevoidcasa" class="form-control mb" pattern="{1,15}" required=""/>
