    ...
    <div class="col-md-6 col-md-offset-3"><br>
        <div class="well row pt-2x pb-3x bk-light">
          <div class="col-md-8 col-md-offset-2">
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="registro_habitaciones_buscador.php" width="150" height="500">
              <div class="mt">

                <label for="" class="text-uppercase text-sm">Introduzca el nombre de la habitacion</label>
                <input type="text" placeholder="Escriba el nombre de la habitacion" id='nombrehabitacion' name="nombrehabitacion" class="form-control mb" pattern="[a-zA-Zñ ]+[a-zA-Zñ]{1,20}" required />

                <button class="btn btn-primary btn-block" type="submit" name='Enviar' class="boton" value='Enviar'>Enviar</button>
                <br><br>
