	...
	<div class="row">
		...
		<section> <center>
			<ul>
				...
				<li><p><a class="form-control mb" href='registro_usuario.php'>Dar de alta usuario</a></p></li>
				<li><p><a class="form-control mb" href='borrarusuario.php'>Borrar un Usuario</a></p></li>
				<li><p><a class="form-control mb" href="editar_usuario.php">Editar Usuario</a></p></li>
				<li><p><a class="form-control mb" href='bloquser.php'>Bloquear/Desbloquear un Usuario</a></p></li>
				<li><a class="form-control mb" href="asignar_posesiones/buscadoranadirusuarioacasapropietario.php">Asignaciones de usuarios/casas</a></li>
			</ul>
			<br><br>
			<a class="btn btn-primary btn-block" href="javascript:history.back()"> Volver Atras</a>
		</section>
	</div>
</div>
</div>
