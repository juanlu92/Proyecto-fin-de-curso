    ...
    <div class="col-md-6 col-md-offset-3"><br><br>
        <div class="well row pt-2x pb-3x bk-light">
          <div class="col-md-8 col-md-offset-2">
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="editar_casa.php" width="150" height="500">
              <?php
              session_start();
              ...
              echo "<pre class='form-control mb'>Casa encontrada: </pre>";
              echo "<select name='habitacionencontrada'>";

              while ($row = mysql_fetch_array($query)){
              echo "<option name='todainformacion' class='form-control mb' value='" .$row['nombre']."'>".$row['idCasa'] .' ||| Nombre ->'.$row['nombre']."</option>";
              		}
