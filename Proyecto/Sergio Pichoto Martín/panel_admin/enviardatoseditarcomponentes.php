  ...
  <div class="ts-main-content">
      ...
      <div class="container">
        ...
        <?php
            ...
            echo '<br>';
            echo '<br>';
            $viejotipo = $_SESSION['viejotipo'];
            $nuevotipo = $_POST['nuevotipo'];
            $privilegiosnuevos = $_POST['privilegiosnuevos'];
            echo '<br>';
            echo '<br>';
            echo '<br>';
            $editarcomponentes=new Componentes;
            $editarcomponentes->editarcomponentes($viejotipo, $nuevotipo, $privilegiosnuevos);
        ?>
