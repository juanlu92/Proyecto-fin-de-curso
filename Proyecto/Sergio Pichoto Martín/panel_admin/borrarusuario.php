  ...
  <div class="form-content">
    <div class="container">
      <div class="row">
            ...
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatosborrarusuario.php" width="150" height="500">
              <div class "mt">

                <label for="" class="text-uppercase text-sm">  Escribe el correo electrónico del usuario a borrar:</label>
                <input type="text" placeholder="Escriba el Correo del usuario" id='email' name="email" class="form-control mb" required />
