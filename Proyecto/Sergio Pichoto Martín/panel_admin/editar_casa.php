...
<?php
session_start();
$habitacionencontrada=$_POST['habitacionencontrada'];
$_SESSION['habitacionencontrada']=$habitacionencontrada;
?>
<html leng = "es">
<head>
  <meta charset = "UTF-8">
  ...
  <body background=".././Recursos/img/fondo.jpg">
      ...
      <li><a href='.././login/logout.php'>Cerrar Sesion</a></li>
            ...
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatoseditarcasa.php" width="150" height="500">
              <div class "mt">
              <label for="" class="text-uppercase text-sm">Nuevo nombre de casa:</label>
              <input type="text" placeholder="Escriba el nuevo nombre de la casa" id='nombrecasa' name="nombrecasa" class="form-control mb" pattern="[a-zA-Zñ ]+[a-zA-Zñ]{1,15}" required=""/>
