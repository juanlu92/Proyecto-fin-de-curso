  ...
  <div class="ts-main-content">
      ...
      <div class="container">
  				...
  				<div class="col-md-6 col-md-offset-3"><br>
  						<div class="well row pt-2x pb-3x bk-light">
  							<div class="col-md-8 col-md-offset-2"><br><br><br>
  								<section> <center>
  									<ul>
  				<label for="" class="text-uppercase text-sm">enhorabuena, se ha editado el usuario
        ...
        <?php
            ...
            echo '<br>';
            echo '<br>';
            $correoidusuario = $_POST['correoidusuario'];
            $esadmin = $_POST['editaradmin'];
            $nombre = $_POST['nombre'];
            ...
            $editarusuario->editarusuario($correoidusuario, $esadmin, $nombre, $apellidouno, $apellidodos, $editaremail);
        ?>
