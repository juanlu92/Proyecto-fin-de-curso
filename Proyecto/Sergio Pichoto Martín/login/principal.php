			...
			<div class="container">
				<div class="row">
					<div class="col-md-6 col-md-offset-3">
						<h1 class="text-center text-bold text-light mt-4x">Bienvenido, inicia sesión.</h1>
						<div class="well row pt-2x pb-3x bk-light">
							<div class="col-md-8 col-md-offset-2">
                <label for="" class="text-uppercase text-sm">¿No estas registrado?</label><br>
                <a class="btn btn-primary btn-block"  href='.././panel_user/nuevouser/registrate.php'>¡REGISTRATE!</button></a>
