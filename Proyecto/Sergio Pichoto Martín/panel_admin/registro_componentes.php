    ...
    <div class="col-md-6 col-md-offset-3"><br>
        <div class="well row pt-2x pb-3x bk-light">
          <div class="col-md-8 col-md-offset-2">
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="enviardatosaltacomponente.php" width="150" height="500">
              <div class="mt">

                <label for="" class="text-uppercase text-sm">Tipo de componente</label>
                <input type="text" placeholder="Escriba el tipo de componente" id='tipocomponente' name="tipocomponente" class="form-control mb" pattern="[a-zA-Zñ ]+[a-zA-Zñ]{1,20}"  required />
