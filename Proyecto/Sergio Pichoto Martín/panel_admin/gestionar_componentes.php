...
<div class="container">
	<div class="row">
		...
		<section> <center>
			<ul>
				<label for="" class="text-uppercase text-sm">Gestor de componentes, elija una opción </label><br>
				<p><a class="form-control mb" <a href='registro_componentes.php'>Dar de alta componentes</a></p>
				<p><a class="form-control mb" <a href='borrarcomponentes_buscador.php'>Borrar componente</a></p>
				<p><a class="form-control mb" <a href='editar_componentes_buscador.php'>Editar componente</a></p>
			</ul>
			<br><br>
