...
<div class="container">
	<div class="row">
		...
		<section> <center>
			<ul>
				<label for="" class="text-uppercase text-sm">Gestor de habitaciones, elija una opción </label><br>
				<p><a class="form-control mb" href='registro_habitaciones.php'>Dar de alta habitaciones</a></p>
				<p><a class="form-control mb" href='borrarhabitaciones_buscador.php'>Borrar habitaciones</a></p>
				<p><a class="form-control mb" href='editar_habitaciones.php'>Editar habitaciones</a></p>
				<p><a class="form-control mb" href="buscador_busqueda_habitacion.php">Añadir un componente a una habitación</a></p>
			</ul>
			<br><br>
