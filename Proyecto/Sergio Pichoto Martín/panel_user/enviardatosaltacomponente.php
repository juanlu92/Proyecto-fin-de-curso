...
<head>
  ...
  <li><a href="Inicio.php">Panel Administrador Principal</a></li>
  ...
  <div class="ts-main-content">
      ...
      <div class="container">
        ...
        <?php
            ...
            echo '<br>';
            echo '<br>';
            $ordenar=mysql_query('ALTER TABLE Componentes AUTO_INCREMENT=1');
            $altacomponente=new Componentes;
            $altacomponente->altacomponente($tipocomponente, $privilegios);
        ?>
