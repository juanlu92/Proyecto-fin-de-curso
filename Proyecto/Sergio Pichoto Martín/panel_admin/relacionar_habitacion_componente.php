...
$privilegio=$_SESSION['privilegiosfinal'];
$idusuario=$_POST['iddeusuario'];



$insertado=mysql_query("INSERT INTO Pertenece VALUES('$idHabitacion','$idComponente','$idusuario','$privilegio')") or die (mysql_error());;
if ($insertado) {
  echo "";
}
?>
