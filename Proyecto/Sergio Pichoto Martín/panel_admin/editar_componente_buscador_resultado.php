    ...
    <div class="col-md-6 col-md-offset-3"><br><br>
        <div class="well row pt-2x pb-3x bk-light">
          <div class="col-md-8 col-md-offset-2">
            <form id="f1" name="f1" method="post" onsubmit="return validar();" action="editar_componentes.php" width="150" height="500">
              <?php
              session_start();
              ...
              echo "<pre class='form-control mb'>Componente Encontrado: </pre>";
              echo "<select name='viejotipo'>";

              while ($row = mysql_fetch_array($query)){
              echo "<option name='todainformacion' class='form-control mb' value='" .$row['tipo']."'>".$row['idComponente'] .' ||| Nombre ->'.$row['tipo']."</option>";
              		}
              echo "<input type='submit' class='btn btn-primary btn-block' value='Elegir' name='submit'>";
              echo "<br><br>";
